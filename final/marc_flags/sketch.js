...
// load the data
d3.json("links.json", function(error, _graph) {
...
function ticked() {
  link
    .attr("x1", function(d) { if (d.distance < 10 || d.distance > 310) {return d.source.x;} })
    .attr("y1", function(d) { if (d.distance < 10 || d.distance > 310) {return d.source.y;} })
    .attr("x2", function(d) { if (d.distance < 10 || d.distance > 310) {return d.target.x;} })
    .attr("y2", function(d) { if (d.distance < 10 || d.distance > 310) {return d.target.y;} });
